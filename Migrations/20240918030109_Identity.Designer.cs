...
namespace apiPoc.Migrations
{
    ...
    [Migration("20240918030109_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIPOC.Entities.Ingrediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("APIPOC.Entities.Rango", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IngredienteRango", b =>
                {
                    b.HasOne("APIPOC.Entities.Ingrediente", null)
                        .WithMany()
                        .HasForeignKey("IngredientesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APIPOC.Entities.Rango", null)
                        .WithMany()
